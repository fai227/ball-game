...
// ボール辞典
const BallName = ["ビーだま", "スーパーボール", "ピンポンだま", "ゴルフボール", "ビリヤードだま", "テニスボール", "やきゅうボール", "アメフトボール", "バレーボール", "サッカーボール", "クリスマスリース", "???"];
...
const IllustTips = shuffle([
    ...
    "クリスマスリースは「モッ」とした口がミソ。ゲーム中に見る機会が少ないのがかなしいね",
]);
